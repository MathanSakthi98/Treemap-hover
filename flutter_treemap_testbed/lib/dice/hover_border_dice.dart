...
class DiceHierarchicalHoverBorderSample extends StatefulWidget {
  @override
  _DiceHierarchicalHoverBorderSampleState createState() =>
      _DiceHierarchicalHoverBorderSampleState();
}

class _DiceHierarchicalHoverBorderSampleState
    extends State<DiceHierarchicalHoverBorderSample> {
...
class DiceFlatHoverBorderSample extends StatefulWidget {
  _DiceFlatHoverBorderSampleState createState() =>
      _DiceFlatHoverBorderSampleState();
}

class _DiceFlatHoverBorderSampleState extends State<DiceFlatHoverBorderSample> {
