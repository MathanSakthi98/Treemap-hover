...
class DiceHoverSample extends StatefulWidget {
  @override
  _DiceHoverSampleState createState() => _DiceHoverSampleState();
}

class _DiceHoverSampleState extends State<DiceHoverSample> {
