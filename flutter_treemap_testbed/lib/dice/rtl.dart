...
class DiceRTLFlatSample extends StatefulWidget {
  @override
  _DiceRTLFlatSampleState createState() => _DiceRTLFlatSampleState();
}

class _DiceRTLFlatSampleState extends State<DiceRTLFlatSample> {
  ...
  void initState() {
    _source = <Population>[
      ...
      Population('Africa', 'South Africa', 12.4),
      Population('Africa', 'North Africa', 8.4),
      Population('Africa', 'Ease Africa', 5.4),
