...
class HoverWithTooltip extends StatefulWidget {
  _HoverWithTooltipState createState() => _HoverWithTooltipState();
}

class _HoverWithTooltipState extends State<HoverWithTooltip> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Hover with tooltip')),
      body: SfTreemap.dice(
