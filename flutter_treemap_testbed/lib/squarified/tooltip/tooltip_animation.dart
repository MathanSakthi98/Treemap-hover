...
class SquarifiedTreemapTooltipAnimationSample extends StatefulWidget {
  @override
  _SquarifiedTreemapTooltipAnimationSampleState createState() =>
      _SquarifiedTreemapTooltipAnimationSampleState();
}

class _SquarifiedTreemapTooltipAnimationSampleState
    extends State<SquarifiedTreemapTooltipAnimationSample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Squarified Tooltip Animation Sample'),
      ),
      body: Column(
        children: [
          Expanded(
                ...
                levels: [
                  TreemapLevel(
                    ...
                    groupMapper: (int index) =>
                        _onlineMarketSource[index].country,
