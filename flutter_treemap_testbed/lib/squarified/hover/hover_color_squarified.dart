...
class SquarifiedFlatHoverColorSample extends StatefulWidget {
  _SquarifiedFlatHoverColorSampleState createState() =>
      _SquarifiedFlatHoverColorSampleState();
}

class _SquarifiedFlatHoverColorSampleState
    extends State<SquarifiedFlatHoverColorSample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SfTreemap(
        ...
        tileHoverColor: (Colors.yellowAccent),
        levels: [
          TreemapLevel(
...
class SquarifiedHoverColorHierarchicalSample extends StatefulWidget {
  @override
  _SquarifiedHoverColorHierarchicalSampleState createState() =>
      _SquarifiedHoverColorHierarchicalSampleState();
}

class _SquarifiedHoverColorHierarchicalSampleState
    extends State<SquarifiedHoverColorHierarchicalSample> {
