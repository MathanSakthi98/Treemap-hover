...
class SquarifiedDefaultHoverSample extends StatefulWidget {
  @override
  _SquarifiedDefaultHoverSampleState createState() =>
      _SquarifiedDefaultHoverSampleState();
}

class _SquarifiedDefaultHoverSampleState
    extends State<SquarifiedDefaultHoverSample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Squarified Default hover'),
      ),
      body: Column(
        children: [
          Expanded(
