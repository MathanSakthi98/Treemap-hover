...
class SliceFlatHoverColorSample extends StatefulWidget {
  _SliceFlatHoverColorSampleState createState() =>
      _SliceFlatHoverColorSampleState();
}

class _SliceFlatHoverColorSampleState extends State<SliceFlatHoverColorSample> {
...
class SliceHierarchicalHoverColorSample extends StatefulWidget {
  @override
  _SliceHierarchicalHoverColorSampleState createState() =>
      _SliceHierarchicalHoverColorSampleState();
}

class _SliceHierarchicalHoverColorSampleState
    extends State<SliceHierarchicalHoverColorSample> {
