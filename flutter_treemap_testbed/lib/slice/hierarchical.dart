...
class SliceHierarchicalSample extends StatefulWidget {
  @override
  _SliceHierarchicalSampleState createState() =>
      _SliceHierarchicalSampleState();
}

class _SliceHierarchicalSampleState extends State<SliceHierarchicalSample> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Slice hierarchical level'),
      ),
