...
class SliceRTLFlatSample extends StatefulWidget {
  @override
  _SliceRTLFlatSampleState createState() => _SliceRTLFlatSampleState();
}

class _SliceRTLFlatSampleState extends State<SliceRTLFlatSample> {
