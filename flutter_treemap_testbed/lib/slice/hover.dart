...
class SliceHoverSample extends StatefulWidget {
  @override
  _SliceHoverSampleState createState() => _SliceHoverSampleState();
}

class _SliceHoverSampleState extends State<SliceHoverSample> {
