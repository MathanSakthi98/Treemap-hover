...
class SliceTreemapTooltipAnimationSample extends StatefulWidget {
  @override
  _SliceTreemapTooltipAnimationSampleState createState() =>
      _SliceTreemapTooltipAnimationSampleState();
}

class _SliceTreemapTooltipAnimationSampleState
    extends State<SliceTreemapTooltipAnimationSample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Slice Tooltip Animation Sample'),
      ),
      body: Column(
        children: [
          Expanded(
