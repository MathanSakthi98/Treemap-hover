...
class SliceHierarchicalHoverBorderSample extends StatefulWidget {
  @override
  _SliceHierarchicalHoverBorderSampleState createState() =>
      _SliceHierarchicalHoverBorderSampleState();
}

class _SliceHierarchicalHoverBorderSampleState
    extends State<SliceHierarchicalHoverBorderSample> {
...
class SliceFlatHoverBorderSample extends StatefulWidget {
  _SliceFlatHoverBorderSampleState createState() =>
      _SliceFlatHoverBorderSampleState();
}

class _SliceFlatHoverBorderSampleState
    extends State<SliceFlatHoverBorderSample> {
