...
class TooltipSliceSample extends StatefulWidget {
  @override
  _TooltipSliceSampleState createState() => _TooltipSliceSampleState();
}

class _TooltipSliceSampleState extends State<TooltipSliceSample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Slice tooltip sample'),
      ),
